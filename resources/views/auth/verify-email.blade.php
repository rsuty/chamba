                ...
                <div class="auth-box-3">
                    ...
                    <div class="text-center 2xl:mb-10 mb-5">
                        ...
                        <div class="text-slate-500 dark:text-slate-400 text-base">
                            You must verify you email address before you can sign in.
                        </div>
                    </div>
                    <!-- BEGIN: Login Form -->
                    @if ($errors->any())
                    ...
                    <form class="space-y-4" action="{{ route('verification.send') }}" method="post">
                        ...
                        <button type="submit" class="btn btn-dark block w-full text-center">Resend Email</button>
                    </form>
                    <!-- END: Login Form -->
